                        ...
                        <div className="w-full py-6 z-20">
                            ...
                            <form onSubmit={sendOtp} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                                ...
                                <div className="pb-2 pt-4">
                                    <input type="text" name="name" id="name" placeholder="Name" value={name} className="block w-full p-4 text-lg rounded-sm bg-black" required
                                        onChange={(e) => setName(e.target.value)} />
                                </div>
                                <div className="pb-2 pt-4">
                                    <input type="email" name="email" id="email" placeholder="Email" value={email} className="block w-full p-4 text-lg rounded-sm bg-black" required
                                        onChange={(e) => setEmail(e.target.value)} />
                                </div>
                                <div className="pb-2 pt-4">
                                    <input className="block w-full p-4 text-lg rounded-sm bg-black" value={mobile} type="number" name="mobile" id="mobile" placeholder="Mobile" required
                                        onChange={(e) => setMobile(e.target.value)} />
                                </div>
                                <div className="pb-2 pt-4">
                                    <input className="block w-full p-4 text-lg rounded-sm bg-black" value={password} type="password" name="password" id="password" placeholder="Password" required
