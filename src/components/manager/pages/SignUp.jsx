...
function SignUp() {
  ...
  const managerData = {
    name, email, state, place, mobile, address, company, pincode, district, password,
  };
      ...
      <body className="overflow-hidden md:flex items-center justify-center my-20">
        ...
        <section className="md:flex items-stretch bg-slate-950 text-white w-4/5 mx-auto">
          <div className="lg:flex lg:w-1/3 hidden lg:bg-gray-500 relative items-center bg-[url('/dec4.png')]">
            <div className="absolute md:bg-black md:opacity-60 inset-0 z-0" />
          </div>
          <div className="lg:w-3/4 sm:w-full md:flex items-center md:px-16 z-0 md:bg-slate-950 px-5">
            <div className="md:absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center">
              <div className="absolute md:bg-black opacity-60 inset-0 z-0" />
            </div>
            <div className="">
              <h1 className="my-6 w-auto inline-flex font-semibold text-3xl">
                Hey, Event Manager
              </h1>
              ...
              <div className="sm:w-2/3 w-full lg:px-0">
                <div className="pb-1 pt-2">
                  <label className="text-left text-gray-400 ps-2" htmlFor="">
                    Name
                    {' '}
                  ...
                  <input
                    ...
                    placeholder="Name"
                    value={name}
                    className="mt-2 block w-full p-3 text-lg rounded-sm bg-black"
                ...
                <div className="pb-1 pt-2">
                  <label className="text-left text-gray-400 ps-2" htmlFor="image">
                    Aadhar card
                    {' '}
                    <span className="text-red-600">*</span>
                  </label>
                  <input
                    className="block w-full mt-2 p-3 text-lg rounded-sm bg-black"
                    type="file"
                    accept="image/*"
                    name="aadhar"
                    id="aadhar"
                ...
                <div className="pb-1 pt-2">
                  ...
                  <input
                    className="block w-full p-3 text-lg rounded-sm bg-black mt-2"
                    type="file"
                    accept="image/*"
                    name="mobile"
                    id="mobile"
